...
Save generated slide decks under the repo root at `marp_slides/` (create the folder if needed), using `.md` extension:
...
This skill is part of an external agent-skills project.
